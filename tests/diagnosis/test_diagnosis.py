...
class TestDiagnosis(unittest.TestCase):
    ...
    def prepare_data(self):
        clauses=[
            {"id":13,"fang":"桂枝汤","patterns":["太阳病","发热","恶寒","汗出","恶风"]},
            {"id":14,"fang":"桂枝加葛根汤","patterns":["太阳病","项背强几几","汗出","恶风"]},
            {"id":27,"fang":"桂枝二越婢一汤","patterns":["太阳病","发热","恶寒","热多寒少","脉微弱"]},
            {"id":35,"fang":"麻黄汤","patterns":["太阳病","头痛","发热","身疼","腰痛","骨节疼痛","恶风","无汗","喘"]},
            {"id":42,"fang":"桂枝汤","patterns":["太阳病","外证未解","脉浮弱"]},
            {"id":44,"fang":"桂枝汤","patterns":["太阳病","外证未解"]},
            {"id":45,"fang":"桂枝汤","patterns":["太阳病","先发汗不解","脉浮"]}
        ]
        ...
        for clause in clauses:
            clause_id=clause["id"]
            fang=clause["fang"]
            patterns={s:Decimal() for s in clause["patterns"]}
            clause_fang_patns.append(ClauseFangPatn(clause_id=clause_id,
                                                    fang_patns=[FangPatn(fang=fang,patterns=patterns)]))
        ...
        self.expected_tf_idf2={#key的格式="条文编号-方名-防同名方剂后缀"，类似数据库的多列主键
            "13-桂枝汤-0":{"太阳病":'0.000',"发热":'0.074',"恶寒":'0.109',"汗出":'0.109',"恶风":'0.074'},
        ...
        self.expected_BM25={#key的格式="条文编号-方名-防同名方剂后缀"，类似数据库的多列主键
            "13-桂枝汤-0":{"太阳病":'0.000',"发热":'0.368',"恶寒":'0.544',"汗出":'0.544',"恶风":'0.368'},
            "14-桂枝加葛根汤-0":{"太阳病":'0.000',"项背强几几":'0.845',"汗出":'0.544',"恶风":'0.368'},
            "27-桂枝二越婢一汤-0":{"太阳病":'0.000',"发热":'0.368',"恶寒":'0.544',"热多寒少":'0.845',"脉微弱":'0.845'},
            "35-麻黄汤-0":{"太阳病":'0.000',"头痛":'0.845',"发热":'0.368',"身疼":'0.845',"腰痛":'0.845',"骨节疼痛":'0.845',"恶风":'0.368',"无汗":'0.845',"喘":'0.845'},
            "42-桂枝汤-0":{"太阳病":'0.000',"先发汗不解":'0.368',"脉浮弱":'0.845'},
            "44-桂枝汤-0":{"太阳病":'0.000',"先发汗不解":'0.368'},
            "45-桂枝汤-0":{"太阳病":'0.000',"先发汗不解":'0.368',"脉浮":'0.845'}
        }
    ...
    def test_build_correlation_avg(self):
        ...
        for entry in diagnosis.clause_fang_patns:
            for fang_patn in entry.fang_patns:
                for patn,weight in fang_patn.patterns.items():
                    norm_patn=diagnosis.normalize_term(patn,self.norm)
                    assert Decimal(expected[fang_patn.fang][norm_patn])==weight
